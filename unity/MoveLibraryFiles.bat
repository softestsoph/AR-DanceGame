...
copy %BODY_TRACKING_TOOLS_PATH%vcomp140.dll Assets\Plugins
copy %BODY_TRACKING_TOOLS_PATH%cudnn_cnn_infer64_8.dll Assets\Plugins
copy %BODY_TRACKING_TOOLS_PATH%cudnn_ops_infer64_8.dll Assets\Plugins
